<template>
	...
	>
		<path
			fill-rule="evenodd"
			clip-rule="evenodd"
			d="M5 8C4.44772 8 4 8.44772 4 9V19C4 20.6569 5.34315 22 7 22H17C18.6569 22 20 20.6569 20 19V9C20 8.44772 19.5523 8 19 8H5ZM9 11C9.55228 11 10 11.4477 10 12V18C10 18.5523 9.55228 19 9 19C8.44772 19 8 18.5523 8 18V12C8 11.4477 8.44772 11 9 11ZM16 12C16 11.4477 15.5523 11 15 11C14.4477 11 14 11.4477 14 12V18C14 18.5523 14.4477 19 15 19C15.5523 19 16 18.5523 16 18V12Z"
			fill="#6F767E"
		/>
		<path
			d="M4 6C3.44772 6 3 5.55228 3 5C3 4.44772 3.44772 4 4 4H7.17071C7.58254 2.83481 8.69378 2 10 2H14C15.3062 2 16.4175 2.83481 16.8293 4H20C20.5523 4 21 4.44772 21 5C21 5.55228 20.5523 6 20 6H4Z"
			fill="#6F767E"
		/>
	</svg>
</template>
