			...
			<div class="authorization__container">
				<div class="sign-in">
					...
					<div class="sign-in__container">
						...
						<form
							class="sign-in__form form-component"
							autocomplete="off"
							novalidate
							@submit.prevent
						>
							...
							<v-button
								:disabled="
									(v$.email.$invalid && v$.email.$error) ||
									(v$.password.$invalid && v$.password.$error) ||
									isLoading
								"
								label="Sign in"
								color="primary"
							...
							<div class="sign-in__sign-up-link">
								Don’t have an account? <a class="v-link" href="/sign-up"> Sign up</a>
							</div>
						</form>
					</div>
				</div>
...
export default {
	name: 'SignIn',
	components: { VInputIcon, VSocialList, VButton, VCaptcha, VLogotype },
	data() {
		return {
			v$: useVuelidate(),
